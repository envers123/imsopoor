...
## Commits
* Bansoukou Patches for AE2UEL 0.56.7 - **Exa** (28 Jan 2026)
* Add EnderIO Conduit Replacer 1.1.0 - **Exa** (28 Jan 2026)
* Add window icons via UT - **Exa** (28 Jan 2026)
* Update UniversalTweaks from 1.14.0 to 1.18.0 - **Exa** (23 Jan 2026)
* Update CraftTweaker from 4.1.20.680 to 4.1.20.709 - **Exa** (23 Dec 2025)
* Update Placebo from 1.6.0 to 1.6.1 - **Exa** (04 Dec 2025)
* Update FoamFix from 0.10.14 to 0.10.15 - **Exa** (04 Dec 2025)
* Update CreativeCore and LittleTiles - **Exa** (04 Dec 2025)
* Update CensoredASM from 5.28 to 5.30 - **Exa** (29 Nov 2025)
* Update StorageDrawers from 5.5.0 to 5.5.3 - **Exa** (24 Nov 2025)
* Update HEI from 4.29.8 to 4.29.13 - **Exa** (24 Nov 2025)
* Fix Creative Tank Mold and Small Gear Shape recipes - **Exa** (30 Oct 2025)
* Fix duplicate basic portable tank appearing in HEI - **Exa** (03 Oct 2025)
* Update HEI from 4.28.0 to 4.29.8 - **Exa** (03 Oct 2025)
* Update GTNE from 1.18.6 to 1.18.7, SoG from 3.0.3 to 3.0.4 - **Exa** (11 Sep 2025)
* Move item custom name assignments from scripts to en_us.lang - **Exa** (06 Jul 2025)
* Fix ExtendedCrafting recipes not requiring the correct size of table - **Exa** (05 Jul 2025)
* Adjust Suit Workstation Quest - **Exa** (12 Jun 2025)
* Switch from JEI 4.16.1.302 to HEI 4.28.0 - **Exa** (12 Jun 2025)
* Update MultiblockTweaker from 1.8.0 to 1.8.1 - **Exa** (12 Jun 2025)
* Bansoukou patch for Multiblock Tweaker - **Exa** (15 Mar 2025)
* Update AE2 Unofficial Extended Life from v0.56.5 to v0.56.7 - **Exa** (15 Mar 2025)
* Update GregTech Nomifactory Edition from 1.18.5 to 1.18.6 - **Exa** (15 Mar 2025)
* Update PackagedAuto from 1.0.15.58 to 1.0.17.62 - **Exa** (13 Mar 2025)
* Give Radium Salt Ore Dictionary entries - **Exa** (13 Mar 2025)
* Add UniversalTweaks 1.14.0 - **Exa** (22 Feb 2025)
* Update CensoredASM from 5.20 to 5.25 - **Exa** (22 Feb 2025)
* Update Solar Flux Reborn from 4.35r to 12.4.11 - **Exa** (21 Feb 2025)
* Update Multiblock Tweaker from 1.6.0 to 1.8.0 - **Exa** (27 Dec 2024)
* Update DeepMobEvolution from 1.2.2 to 1.2.3 - **Exa** (24 Dec 2024)
* Replace RealBench 1.3.3 with RealBench Nomi-CEu v1.0.4 (#996) - **Integer Limit** (09 Dec 2024)
* Fix CEF quest text (batteries do not affect amps) - **Exa** (07 Sep 2024)
* Update PackagedAuto from 1.0.6.21 to 1.0.13.49 - **Exa** (31 May 2024)
* Update StorageDrawers 5.4.2 to 5.5.0 - **Exa** (29 May 2024)
* Mention Crystal Growth Chamber needs AE power in quest - **Exa** (06 Jun 2024)
* Update Processing Array quest text (SoG 3.0.1 changes) - **Exa** (06 Jun 2024)
* Update NAE2 from 1.6.2 to 1.6.4 - **Exa** (28 May 2024)
* Update AE2 Unofficial Extended Life from v0.56.4 to v0.56.5 - **Exa** (28 May 2024)
* Balance adjustment: Moon turf now macerates into two dusts - **Exa** (24 May 2024)
* Bansoukou patches for DeepMobLearning 1.2.2 - **Exa** (24 May 2024)
* Switch to GregTech Nomifactory Edition & Update SoG - **Exa** (23 May 2024)
