...
mixer.recipeBuilder()
	.inputs([
		...
		<ore:nuggetNeutronium> *8
	])
	.fluidInputs([<liquid:unspaceflu> * 500])
	.fluidOutputs(<liquid:spacefluid> * 10)
	.EUt(160000)
	.duration(10)
	.buildAndRegister();
...
fusion_reactor.recipeBuilder()
	.fluidInputs([<liquid:moltennetherstar> * 1000, <liquid:neutronium> * 1000])
    .fluidOutputs(<liquid:unspaceflu> * 10)
    .duration(100)
    .EUt(15360)
    .property("eu_to_start", 400000000)
    .buildAndRegister();