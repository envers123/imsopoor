...
var DimensionallySplitNeuralSuperarray = VanillaFactory.createItem("DimensionallySplitNeuralSuperarray");
DimensionallySplitNeuralSuperarray.maxStackSize = 64;
DimensionallySplitNeuralSuperarray.register();
...
makeFluid("spacefluid",                 "000000",   false,  1024,       "COMMON",   0);
makeFluid("unspaceflu",                 "000000",   false,  1024,       "COMMON",   0);
