...
///////////// Tier Ten Circuits | Spacial Tier //////////////


<contenttweaker:dimensionallysplitneuralsuperarray>.addTooltip(format.aqua(format.italic("This is the Only Tier Infinity Array.")));

assembly_line.recipeBuilder().inputs([<metaitem:component.smd.diode> * 64, <metaitem:plate.high_power_integrated_circuit> * 64, <metaitem:component.smd.transistor> * 64, <extendedcrafting:singularity_ultimate> * 16, <gregtech:meta_item_2:32449> * 64, <gregtech:meta_item_1:32677> * 64, <ore:plateInfinity> * 64, <ore:wireGtSingleSuperconductor> * 64]).fluidInputs(<liquid:soldering_alloy> * 100000).fluidInputs(<liquid:spacefluid> * 10000).outputs([<contenttweaker:dimensionallysplitneuralsuperarray>]).duration(600).EUt(3000000).buildAndRegister();
